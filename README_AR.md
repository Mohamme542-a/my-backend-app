...
### وضع التطبيق المحلي WebView / PWA

لا يعتمد Archive على رابط موقع خارجي داخل التطبيق. صفحة `/` نفسها هي الـ App Shell المحلي، وتعمل بوضع `standalone` عند التثبيت من Chrome أو Edge أو Safari. بعد تشغيل المشروع، اختر **تثبيت التطبيق** أو **إضافة إلى الشاشة الرئيسية** من قائمة المتصفح؛ ستفتح Archive في نافذة تطبيق مستقلة مع نفس الواجهة، والتنقل، والمشغلات، ونافذة PDF الموجودة في الموقع.
